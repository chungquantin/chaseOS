...
- **Upgrade 1.7.0 → 1.14.0**: [pop-node PR #178](https://github.com/r0gue-io/pop-node/pull/178)

- **Upgrade 1.14.0 → stable2407**: [pop-node PR #234](https://github.com/r0gue-io/pop-node/pull/234)

Tools that you definitely need for an upgrade

- **psvm**: [Polkadot SDK Version Manager](https://github.com/paritytech/psvm/) - Essential tool for managing Substrate dependencies
...
- **zepter**: [Rust Workspace Analyzer](https://github.com/ggwpez/zepter) - Automatically analyze, fix, and format Rust features
...
- **Polkadot SDK Releases**: [Official Release Page](https://github.com/paritytech/polkadot-sdk/releases) - Track all version updates and changelogs
...
1. First, you will need to find the release of a version you are upgrading to, for example, if you are upgrading to 1.9.0, you will need to find [Polkadot v1.9.0 Release](https://github.com/paritytech/polkadot-sdk/releases/tag/polkadot-v1.9.0)

2. Now take a look at the Changelog section of the release.

![Upgrade Polkadot Version](/blog/upgrade-polkadot-version-1.png)
...
- **Reference PR**: [base-parachain upgrade to 1.14.0](https://github.com/r0gue-io/base-parachain/pull/41) - Compare changes when upgrading to 1.14.0

![Upgrade Polkadot Version](/blog/upgrade-polkadot-version-2.png)
...
![Upgrade Polkadot Version](/blog/upgrade-polkadot-version-3.png)
...
![Upgrade Polkadot Version](/blog/upgrade-polkadot-version-4.png)

Most teams follow the [conventional commit rules](https://www.conventionalcommits.org/en/v1.0.0/) so you can filter out closed PRs that start with `chore` or include `upgrade` to find past PRs.

For example, below are closed PRs from [Frequency Chain](https://github.com/frequency-chain/frequency/pulls?q=is%3Apr+is%3Aclosed+chore%28upgrade%29) that follow the pattern `chore(upgrade)`.

![Upgrade Polkadot Version](/blog/upgrade-polkadot-version-5.png)

## Tips & Tricks

### For a large version bump (maybe from 1.0.0 to 1.15.0 👀), use a tool from Tanssi to track all the changes

**Tanssi Version Tracker**: [print-version-bump-info.ts](https://github.com/moondance-labs/tanssi/blob/master/tools/github/print-version-bump-info.ts)

Tanssi has an internal tool to print version bump information between two versions. For example, [Issue #580](https://github.com/moondance-labs/tanssi/issues/580) prints all changes made to the Polkadot SDK from 1.7.0 to 1.10.0.
...
For detailed context, please take a look at this [Substrate StackExchange post](https://substrate.stackexchange.com/questions/11774/unable-to-compile-upgrade-parachain-node-after-running-psvm-v1-13-0) about upgrading to v1.13.0 (the PR that took me hours and help from colleagues to resolve).

![Upgrade Polkadot Version](/blog/upgrade-polkadot-version-6.png)
...
**Polkadot Forum**: [Omni-node Discussion](https://forum.polkadot.network/t/polkadot-parachain-omni-node-gathering-ideas-and-feedback/7823/23) - Community feedback and ideas
