...
> **Original Thread**: [Read the full thread on X](https://x.com/chungquantin/status/1809864276850704882)
...
![Sharded Network Visualization](/blog/break-down-the-sharded-network-design-of-polkadot__image_1.jpeg)
...
> **Reference**: [2.4. High-Performance Fully Synchronous Networks - JAM Gray Paper](https://github.com/paritytech/polkadot-sdk/blob/master/docs/jam-gray-paper.pdf) by Gavin Wood
...
> **Deep Dive**: [Collation Protocol Documentation](https://paritytech.github.io/polkadot-sdk/book/node/collators/collator-protocol.html) - Learn how parachain blocks are collated and included
...
![Sharded Network Visualization](/blog/break-down-the-sharded-network-design-of-polkadot__image_2.jpeg)
...
> **Thread**: [Polkadot's Hybrid Consensus](https://x.com/chungquantin/status/1808726232827318778) - Understanding block production and finality mechanisms
...
![Sharded Network Visualization](/blog/break-down-the-sharded-network-design-of-polkadot__image_3.jpeg)
...
> **Documentation**: [Availability Core API](https://paritytech.github.io/polkadot-sdk/book/runtime-api/availability-cores.html) - Technical reference for core allocation mechanisms
