...
> These blog posts are co-authored with [@elastichub](https://x.com/elastic_hub), read the original version on [elastichub.org](https://elastichub.org/p/lean-roadmap-the-future-infrastructure).
